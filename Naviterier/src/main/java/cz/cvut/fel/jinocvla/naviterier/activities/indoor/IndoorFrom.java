...
import cz.cvut.fel.jinocvla.naviterier.activities.outdoor.OutdoorTo;
...
public class IndoorFrom extends Activity implements SchemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schemeStorageService.loadContext(getSchemeActivity(), SchemeActivity.State.PROGRESS);


        this.listView.setItems(this.scheme.getPoints());
    ...
    public static class ListViewFragment extends Fragment {
        ...
        public void openItem(Point point) {
            Intent intent = new Intent(getActivity(), IndoorTo.class);
