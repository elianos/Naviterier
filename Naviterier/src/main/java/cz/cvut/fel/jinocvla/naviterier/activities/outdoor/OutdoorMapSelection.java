...
public class OutdoorMapSelection extends Activity implements SchemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.ms = new MapServiceImpl(this, MapServiceImpl.OUTDOOR_CONTEXT);
...
//        builder.show();
    ...
    public static class ListViewFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            OutdoorMapSelection oms = (OutdoorMapSelection) getActivity();
            this.mapService = oms.ms;
            this.connectionService = oms.connectionService;
