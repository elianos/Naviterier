...
public class IndoorTo extends Activity implements SchemeActivity {
    ...
    public static class ListViewFragment extends Fragment {
        ...
        public void openItem(Point point) {
            ...
            if (point.getId().equals(schemeActivity.getFrom())) {
                ...
                Intent intent = new Intent(getActivity(), IndoorNavigation.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);

                // Store data context
                SchemeStorageService schemeStorageService = SchemeStorageServiceImpl.getInstance(getActivity());
                schemeStorageService.storeContext(schemeActivity, SchemeActivity.State.COMPLETE);
